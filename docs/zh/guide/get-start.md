...
- `安装插件前`请查看对应插件的文档： [TShock中文插件库文档](https://docs.terraria.ink/zh/guide/get-start.html)
...
- 推荐使用单独下载站或[AutoPluginManager](https://api.terraria.ink/apm/api/v1/plugin/12/download)插件安装插件
...
#### [AutoPluginManager](https://api.terraria.ink/apm/api/v1/plugin/12/download)插件 (推荐)

     /apm l [页码] 列出插件列表  
     /apm i <插件序号> 一键安装插件  
     /apm u [插件名] 检查并且更新插件  

- 详细文档：[AutoPluginManager 自动更新插件](https://docs.terraria.ink/zh/guide/AutoPluginManager.html)
